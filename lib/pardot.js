...
module.exports = function(options) {
  ...
  return Q.promise(function(resolve, reject) {
    ...
    Hoek.assert(options.clientId, 'clientId must be specified');
    Hoek.assert(options.clientSecret, 'clientSecret must be specified');
    Hoek.assert(options.username, 'username must be specified');
    Hoek.assert(options.password, 'password must be specified');
    Hoek.assert(options.businessUnitId, 'businessUnitId must be specified');
